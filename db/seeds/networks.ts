...
const NETWORKS: NetworkDef[] = [
  // ── Tier 1 ──────────────────────────────────────────────────────────────
  { code: "ETH",     name: "Ethereum",         chain: "ethereum",      tatumWalletSlug: "ethereum",  nativeCoinCode: "ETH",  decimals: 18, explorerUrl: "https://etherscan.io",                imageUrl: "https://blockchains.tatum.io/assets/img/ethereum.svg" },
  ...
  { code: "MATIC",   name: "Polygon",           chain: "polygon",       tatumWalletSlug: "polygon",   nativeCoinCode: "POL",  decimals: 18, explorerUrl: "https://polygonscan.com",              imageUrl: "https://blockchains.tatum.io/assets/img/polygon.svg" },
  { code: "BTC",     name: "Bitcoin",            chain: "bitcoin",       tatumWalletSlug: "bitcoin",   nativeCoinCode: "BTC",  decimals: 8,  explorerUrl: "https://blockstream.info",             imageUrl: "https://blockchains.tatum.io/assets/img/bitcoin.svg" },
  { code: "SOL",     name: "Solana",             chain: "solana",        tatumWalletSlug: "solana",    nativeCoinCode: "SOL",  decimals: 9,  explorerUrl: "https://solscan.io",                   imageUrl: "https://blockchains.tatum.io/assets/img/solana.svg" },
  { code: "ARB",     name: "Arbitrum One",       chain: "arbitrum-one",  tatumWalletSlug: "arbitrum",  nativeCoinCode: "ETH",  decimals: 18, explorerUrl: "https://arbiscan.io",                  imageUrl: "https://blockchains.tatum.io/assets/img/arbitrum-one.svg" },
  ...
  { code: "AVAX",    name: "Avalanche",          chain: "avalanche-c",   tatumWalletSlug: "avalanche", nativeCoinCode: "AVAX", decimals: 18, explorerUrl: "https://snowtrace.io",                 imageUrl: "https://blockchains.tatum.io/assets/img/avalanche.svg" },
  ...
  { code: "LTC",     name: "Litecoin",           chain: "litecoin",      tatumWalletSlug: "litecoin",  nativeCoinCode: "LTC",  decimals: 8,  explorerUrl: "https://blockchair.com/litecoin",      imageUrl: "https://blockchains.tatum.io/assets/img/litecoin.svg" },
  { code: "DOGE",    name: "Dogecoin",           chain: "dogecoin",      tatumWalletSlug: "dogecoin",  nativeCoinCode: "DOGE", decimals: 8,  explorerUrl: "https://dogechain.info",               imageUrl: "https://blockchains.tatum.io/assets/img/dogecoin.svg" },
  ...
  { code: "ADA",     name: "Cardano",            chain: "cardano",       tatumWalletSlug: "cardano",   nativeCoinCode: "ADA",  decimals: 6,  explorerUrl: "https://cardanoscan.io",               imageUrl: "https://blockchains.tatum.io/assets/img/cardano.svg" },
  ...
  { code: "DOT",     name: "Polkadot",           chain: "polkadot",      tatumWalletSlug: "dot",       nativeCoinCode: "DOT",  decimals: 10, explorerUrl: "https://polkadot.subscan.io",          imageUrl: "https://blockchains.tatum.io/assets/img/polkadot.svg" },
  ...
  { code: "XTZ",     name: "Tezos",              chain: "tezos",         tatumWalletSlug: "xtz",       nativeCoinCode: "XTZ",  decimals: 6,  explorerUrl: "https://tzstats.com",                  imageUrl: "https://blockchains.tatum.io/assets/img/tezos.svg" },
  { code: "EGLD",    name: "MultiversX",         chain: "multiversx",    tatumWalletSlug: "egld",      nativeCoinCode: "EGLD", decimals: 18, explorerUrl: "https://explorer.multiversx.com",      imageUrl: "https://blockchains.tatum.io/assets/img/multiversx.svg" },
  ...
  { code: "ZEC",     name: "Zcash",              chain: "zcash",         tatumWalletSlug: "zcash",     nativeCoinCode: "ZEC",  decimals: 8,  explorerUrl: "https://zcashblockexplorer.com",       imageUrl: "https://blockchains.tatum.io/assets/img/zcash.svg" },
  ...
  { code: "DOT_AH",  name: "Polkadot Asset Hub", chain: "polkadot-assethub", tatumWalletSlug: "polkadot-assethub", nativeCoinCode: "DOT",  decimals: 10, explorerUrl: "https://assethub-polkadot.subscan.io", imageUrl: "https://blockchains.tatum.io/assets/img/polkadot-assethub.svg" },
  { code: "ETC",     name: "Ethereum Classic",   chain: "ethereum-classic", tatumWalletSlug: "ethereumclassic", nativeCoinCode: "ETC",  decimals: 18, explorerUrl: "https://blockscout.com/etc/mainnet",   imageUrl: "https://blockchains.tatum.io/assets/img/ethereum-classic.svg" },
  ...
  { code: "IOTA",    name: "IOTA EVM",           chain: "iota-evm",      tatumWalletSlug: "iota",      nativeCoinCode: "IOTA", decimals: 18, explorerUrl: "https://explorer.iota.org",            imageUrl: "https://blockchains.tatum.io/assets/img/iota.svg" },

  // ── Tier 3 ──────────────────────────────────────────────────────────────
  { code: "ARBNOVA", name: "Arbitrum Nova",       chain: "arbitrum-nova", tatumWalletSlug: "arbitrum-nova", nativeCoinCode: "ETH",  decimals: 18, explorerUrl: "https://nova.arbiscan.io",             imageUrl: "https://blockchains.tatum.io/assets/img/arbitrum-nova.svg" },
  ...
  { code: "KCS",     name: "Kucoin",              chain: "kucoin",        tatumWalletSlug: "kucoin",    nativeCoinCode: "KCS",  decimals: 18, explorerUrl: "https://explorer.kcc.io",              imageUrl: "https://blockchains.tatum.io/assets/img/kucoin.svg" },
  ...
  { code: "KSM_AH",  name: "Kusama Asset Hub",    chain: "kusama-assethub", tatumWalletSlug: "kusama-assethub", nativeCoinCode: "KSM",  decimals: 12, explorerUrl: "https://assethub-kusama.subscan.io",   imageUrl: "https://blockchains.tatum.io/assets/img/kusama-assethub.svg" },
  { code: "VET",     name: "VeChain",             chain: "vechain",       tatumWalletSlug: "vechain",   nativeCoinCode: "VET",  decimals: 18, explorerUrl: "https://explore.vechain.org",          imageUrl: "https://blockchains.tatum.io/assets/img/vechain.svg" },
